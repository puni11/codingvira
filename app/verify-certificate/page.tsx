...
export default function VerifyCertificate() {
  ...
  useEffect(() => {
    if (urlCertificateId) {
      ...
      performVerification(urlCertificateId);
    }
  }, [urlCertificateId, performVerification]);
    ...
    <div className="min-h-screen bg-slate-50 py-36 px-4 md:px-8 font-sans text-slate-900">
      <style jsx global>{`
        @media print {
          ...
          .min-h-screen, .max-w-6xl { padding: 0 !important; margin: 0 !important; background: white !important; }
        }
      `}</style>
